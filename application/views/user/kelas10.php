        ...
        <div class="row" style="color: black; font-family: 'poppins">
            <div class="col-md-12 mt-1 text-center">
                <h1 class="display-4" style="color: black; font-family:'poppins'" data-aos="fade-down"
                    data-aos-duration="1400">Silahkan pilih mapel.
                </h1>
...
echo $data['user']['nama'];
?> 😄</h3>
                    <p data-aos="fade-down" data-aos-duration="1800">Silahkan pilih mapel yang akan kamu akses dibawah
                        ini!
                    </p>
            </div>
        </div>
                ...
                <div class="row mx-auto">
                    ...
                    <div class="col-md-4" data-aos-duration="1900" data-aos="fade-left">
                        <a href="<?=base_url('materi/indo_x')?>">
                            <div class="card" style="width: 21rem;">
                                <img src="<?=base_url('assets/')?>img/Bahasa Indonesia.png" class="card-img-top"
                                    alt="...">
                            </div>
                        </a>
                    </div>
                ...
                <div class="row mx-auto">
                    <div class="col-md-4" data-aos-duration="1900" data-aos="fade-right">
                        <a href="<?=base_url('materi/inggris_x')?>">
                            <div class="card" style="width: 21rem;">
                                <img src="<?=base_url('assets/')?>img/Bahasa Inggris.png" class="card-img-top"
                                    alt="...">
                            </div>
                        </a>
                    </div>
